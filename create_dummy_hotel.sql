...
DROP DATABASE IF EXISTS dummy_hotel;

-- Create the database
CREATE DATABASE dummy_hotel;
...
('Grand Plaza Hotel 2', 'Downtown City Center', 'Luxury hotel with stunning views of the city.'),
('Oceanfront Resort & Spa 2', 'Beachfront Paradise', 'Relaxing resort with spa facilities, steps away from the ocean.'),
('Downtown Oasis Hotel 2', 'City Center', 'Modern hotel with a central location, perfect for business travelers.'),
('Seaside Retreat Lodge 2', 'Coastal Area', 'Scenic lodge offering a peaceful escape by the sea.'),
('Mountain View Hotel 2', 'Mountainous Region', 'Elegant hotel surrounded by breathtaking mountain views.'),
('Urban Skyline Suites 2', 'Metropolitan Area', 'Chic suites with panoramic views of the city skyline.'),
('Serenity Valley Resort 2', 'Nature Retreat', 'Tranquil resort nestled in a serene valley for nature enthusiasts.'),
('Historic Heritage Inn 2', 'Historical District', 'Charming inn showcasing rich cultural heritage.'),
('Snowy Peaks Chalet 2', 'Mountain Resort', 'Cozy chalet with a fireplace, perfect for winter getaways.'),
('Riverside Boutique Hotel 2', 'Riverside District', 'Boutique hotel offering a blend of comfort and style by the river.'),
('Grand Plaza Hotel 3', 'Downtown City Center', 'Luxury hotel with stunning views of the city.'),
('Oceanfront Resort & Spa 3', 'Beachfront Paradise', 'Relaxing resort with spa facilities, steps away from the ocean.'),
('Downtown Oasis Hotel 3', 'City Center', 'Modern hotel with a central location, perfect for business travelers.'),
('Seaside Retreat Lodge 3', 'Coastal Area', 'Scenic lodge offering a peaceful escape by the sea.'),
('Mountain View Hotel 3', 'Mountainous Region', 'Elegant hotel surrounded by breathtaking mountain views.'),
('Urban Skyline Suites 3', 'Metropolitan Area', 'Chic suites with panoramic views of the city skyline.'),
('Serenity Valley Resort 3', 'Nature Retreat', 'Tranquil resort nestled in a serene valley for nature enthusiasts.'),
('Historic Heritage Inn 3', 'Historical District', 'Charming inn showcasing rich cultural heritage.'),
('Snowy Peaks Chalet 3', 'Mountain Resort', 'Cozy chalet with a fireplace, perfect for winter getaways.'),
('Riverside Boutique Hotel 3', 'Riverside District', 'Boutique hotel offering a blend of comfort and style by the river.'),
...
('Harbor Breeze Hotel', 'Seaside Promenade', 'Coastal hotel with breezy waterfront views.');
...
INSERT INTO Room (room_number, room_type_id, hotel_id, is_available) VALUES
(101, 1, 1, true),
(102, 2, 2, false),
(201, 3, 3, true),
(301, 4, 4, false),
