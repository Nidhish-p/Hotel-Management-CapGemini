...
public interface RoomRepository extends JpaRepository<Room, Integer> {
    ...
    @EntityGraph(attributePaths = { "hotel", "roomType", "amenities" })
    ...
    @RestResource(path = "byRoomType")
    Page<Room> findByRoomType_RoomTypeId(@Param("roomTypeId") Long roomTypeId, Pageable pageable);
}
